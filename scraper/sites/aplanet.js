/**
 * Scraper configuration for Aplanet (aplanet.org)
 */

module.exports = {
    name: 'Aplanet',
    url: 'https://aplanet.org',
    ...
    async extract(page) {
        return await page.evaluate(() => {
            ...
            const keywords = [];
            const commonKeywords = ['ESG', 'reporting', 'stakeholder', 'materiality', 'responsible business', 'sustainability'];
            ...
            return {
                ...
                reviews: {},
                strategy: {
                    targetMarket: 'Spanish and Latin American companies',
                    differentiators: []
                }
            };
        });
