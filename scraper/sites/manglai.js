/**
 * Scraper configuration for Manglai (manglai.io)
 */
...
module.exports = {
    ...
    async extract(page) {
        return await page.evaluate(() => {
            ...
            const keywords = [];
            const commonKeywords = ['AI', 'sustainability intelligence', 'ESG', 'analytics', 'predictive'];
            ...
            return {
                ...
                reviews: {},
                strategy: {
                    targetMarket: 'Tech-forward companies globally',
                    differentiators: []
                }
            };
        });
