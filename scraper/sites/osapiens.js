/**
 * Scraper configuration for Osapiens (osapiens.com)
 */
...
module.exports = {
    ...
    async extract(page) {
        return await page.evaluate(() => {
            ...
            const keywords = [];
            const commonKeywords = ['sustainability management', 'supply chain', 'compliance', 'LkSG', 'due diligence', 'ESG'];
            ...
            return {
                ...
                reviews: {},
                strategy: {
                    targetMarket: 'German enterprises',
                    differentiators: []
                }
            };
        });
