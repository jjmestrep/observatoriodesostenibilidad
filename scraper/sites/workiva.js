/**
 * Scraper configuration for Workiva (workiva.com)
 */
...
module.exports = {
    ...
    async extract(page) {
        return await page.evaluate(() => {
            ...
            const keywords = [];
            const commonKeywords = ['reporting', 'compliance', 'SEC', 'audit', 'data management', 'ESG'];
            ...
            return {
                ...
                reviews: {},
                strategy: {
                    targetMarket: 'US public companies and large enterprises',
                    differentiators: []
                }
            };
        });
