/**
 * Scraper configuration for Watershed (watershed.com)
 */
...
module.exports = {
    ...
    async extract(page) {
        return await page.evaluate(() => {
            ...
            const keywords = [];
            const commonKeywords = ['enterprise', 'climate', 'decarbonization', 'emissions', 'disclosure', 'carbon'];
            ...
            return {
                ...
                reviews: {},
                strategy: {
                    targetMarket: 'US Fortune 500 and global enterprises',
                    differentiators: []
                }
            };
        });
